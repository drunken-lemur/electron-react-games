...
export class GameScene extends Phaser.Scene {
        ...
        this.asteroids.push(
          new Asteroid({
            ...
            options: {
              x:
                aX === undefined
                  ? GameScene.getRandomSpawnPosition(this.sys.canvas.width)
                  : aX,
              y:
                aY === undefined
                  ? GameScene.getRandomSpawnPosition(this.sys.canvas.height)
                  : aY,
            },
          })
        );
  ...
  private static getRandomSpawnPosition(aScreenSize: number): number {
